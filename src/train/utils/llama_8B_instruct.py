...
PROMPT_PRE = """Extract the most crucial findings from a radiology report in one sentense, focusing on disease identification. Remove all positions, severity, personal identifiers and irrelevant comparisons, make it as short as possible. Produce a concise summary of medical conditions in the following order in one line, each condition separated by a semi-colon: ['Enlarged Cardiomediastinum', 'Cardiomegaly', 'Lung Opacity', 'Lung Lesion', 'Edema', 'Consolidation', 'Pneumonia', 'Atelectasis', 'Pneumothorax', 'Pleural Effusion', 'Pleural Other', 'Fracture', 'Support Devices', 'No Finding']. Do not list the name of support devices, just summerise as support devices.
...
Concise Version: mass in paratracheal region; no pneumothorax; low lung volumes.
...
Concise Version: left retrocardiac opacity; pulmonary edema; no pneumothorax; no pleural effusion; support device in place.
...
Concise Version: enlarged heart; possibly atelectasis or pneumonia; no pulmonary edema; no pneumothorax; probable left pleural effusion; support devices in place.
...
Concise Version: parenchymal opacities; no pleural effusion; support devices in place.
...
output_file = os.path.join(output_dir, "labels.json")
